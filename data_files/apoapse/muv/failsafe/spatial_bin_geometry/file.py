...
path = 'apoapse/muv/failsafe/spatial_bin_geometry'


def add_latitude_to_file(file: File, hduls: generic.hdulist) -> None:
    data = apoapse.muv.failsafe.spatial_bin_geometry.make_spatial_bin_latitude(hduls)
...
def add_longitude_to_file(file: File, hduls: generic.hdulist) -> None:
    data = apoapse.muv.failsafe.spatial_bin_geometry.make_spatial_bin_longitude(hduls)
...
def add_tangent_altitude_to_file(file: File, hduls: generic.hdulist) -> None:
    data = apoapse.muv.failsafe.spatial_bin_geometry.make_spatial_bin_tangent_altitude(hduls)
...
def add_tangent_altitude_rate_to_file(file: File, hduls: generic.hdulist) -> None:
    data = apoapse.muv.failsafe.spatial_bin_geometry.make_spatial_bin_tangent_altitude_rate(hduls)
...
def add_line_of_sight_to_file(file: File, hduls: generic.hdulist) -> None:
    data = apoapse.muv.failsafe.spatial_bin_geometry.make_spatial_bin_line_of_sight(hduls)
...
def add_solar_zenith_angle_to_file(file: File, hduls: generic.hdulist) -> None:
    data = apoapse.muv.failsafe.spatial_bin_geometry.make_spatial_bin_solar_zenith_angle(hduls)
...
def add_emission_angle_to_file(file: File, hduls: generic.hdulist) -> None:
    data = apoapse.muv.failsafe.spatial_bin_geometry.make_spatial_bin_emission_angle(hduls)
...
def add_phase_angle_to_file(file: File, hduls: generic.hdulist) -> None:
    data = apoapse.muv.failsafe.spatial_bin_geometry.make_spatial_bin_phase_angle(hduls)
...
def add_zenith_angle_to_file(file: File, hduls: generic.hdulist) -> None:
    data = apoapse.muv.failsafe.spatial_bin_geometry.make_spatial_bin_zenith_angle(hduls)
...
def add_local_time_to_file(file: File, hduls: generic.hdulist) -> None:
    data = apoapse.muv.failsafe.spatial_bin_geometry.make_spatial_bin_local_time(hduls)
...
def add_right_ascension_to_file(file: File, hduls: generic.hdulist) -> None:
    data = apoapse.muv.failsafe.spatial_bin_geometry.make_spatial_bin_right_ascension(hduls)
...
def add_declination_to_file(file: File, hduls: generic.hdulist) -> None:
    data = apoapse.muv.failsafe.spatial_bin_geometry.make_spatial_bin_declination(hduls)
...
def add_bin_vector_to_file(file: File, hduls: generic.hdulist) -> None:
    data = apoapse.muv.failsafe.spatial_bin_geometry.make_spatial_bin_vector(hduls)
