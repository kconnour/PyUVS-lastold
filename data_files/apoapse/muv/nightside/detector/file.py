...
path = 'apoapse/muv/nightside/detector'


def add_raw_to_file(file: File, hduls: generic.hdulist) -> None:
    data = apoapse.muv.nightside.detector.make_raw(hduls)
...
def add_dark_subtracted_to_file(file: File, hduls: generic.hdulist) -> None:
    data = apoapse.muv.nightside.detector.make_dark_subtracted(hduls)
...
def add_brightness_to_file(file: File) -> None:
    data = apoapse.muv.nightside.detector.make_brightness(file)
