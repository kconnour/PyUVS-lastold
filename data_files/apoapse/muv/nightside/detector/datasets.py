...
def make_brightness(file: File) -> np.ndarray:
    good_integrations = file['apoapse/muv/integration/nightside_integrations'][:]

    dark_subtracted = file['apoapse/muv/nightside/detector/dark_subtracted'][:]
    spatial_bin_edges = file['apoapse/muv/nightside/binning/spatial_bin_edges'][:]
    spectral_bin_edges = file['apoapse/muv/nightside/binning/spectral_bin_edges'][:]
    spatial_bin_width = file['apoapse/muv/nightside/binning/spatial_bin_width'][:]
    spectral_bin_width = file['apoapse/muv/nightside/binning/spectral_bin_width'][:]
